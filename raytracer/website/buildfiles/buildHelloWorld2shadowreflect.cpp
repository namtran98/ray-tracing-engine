...
World::build(void) {
  ...
  reflective_material_red->set_cr(1);
  reflective_material_red->set_kr(1);

  Reflective *reflective_material_lightGreen = new Reflective();
  reflective_material_lightGreen->set_ka(.8);
  reflective_material_lightGreen->set_kd(.8);
  reflective_material_lightGreen->set_cd(lightGreen);
  reflective_material_lightGreen->set_cr(1);
  reflective_material_lightGreen->set_kr(1);

  // sphere
  Sphere* sphere_ptr = new Sphere(Point3D(-1, 3, 0), 3);
  sphere_ptr->set_material(reflective_material_red);
  ...
  sphere_ptr9->set_material(reflective_material_lightGreen);  // light green
  ...
  // vertical plane
  Plane* plane_ptr1 = new Plane(Point3D(0, -80, 0), Vector3D(0, 5, 2));
