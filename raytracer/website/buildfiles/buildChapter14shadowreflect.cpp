...
World::build(void) {
  ...
  Reflective *reflective_material_green = new Reflective();
  reflective_material_green->set_ka(.8);
  reflective_material_green->set_kd(.8);
  reflective_material_green->set_cd(green);
  reflective_material_green->set_cr(1);
  reflective_material_green->set_kr(1);

  Reflective *reflective_material_red = new Reflective();
  reflective_material_red->set_ka(.8);
  reflective_material_red->set_kd(.8);
  reflective_material_red->set_cd(red);
  reflective_material_red->set_cr(.9);
  reflective_material_red->set_kr(.9);
  ...
  sphere_ptr5->set_material(reflective_material_green);  // green
  ...
  sphere_ptr7->set_material(reflective_material_green);  // green
  ...
  sphere_ptr15->set_material(reflective_material_red);  // brown
  ...
  // // plane
  // Plane* plane_ptr2 = new Plane(Point3D(0,-150,0), Vector3D(0, 5, 2));
  // plane_ptr2->set_material(reflective_material_orange); 
  // add_object(plane_ptr2);

  // vertical plane
  Plane* plane_ptr1 = new Plane(Point3D(0, -110, 0), Vector3D(0, 5, 1));
  plane_ptr1->set_material(new Cosine(lightPurple));
