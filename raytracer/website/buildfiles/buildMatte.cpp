...
void World::build(void) {
  ...
  Sphere* sphere_ptr1 = new Sphere(Point3D(-8, 3, 0), 3);
  sphere_ptr1->set_material(matte_material1);  
  add_object(sphere_ptr1);

  Sphere* sphere_ptr2 = new Sphere(Point3D(0, 3, 0), 4);
  sphere_ptr2->set_material(matte_material2); 
  add_object(sphere_ptr2);

  Sphere* sphere_ptr3 = new Sphere(Point3D(8, 3, 0), 3);
  sphere_ptr3->set_material(matte_material3);  
